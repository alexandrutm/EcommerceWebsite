			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="http://localhost/EcommerceProiect/profile.php" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/EcommenceProiect/index.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/EcommenceProiect/index.php">
									<input type="hidden" name="cancel_return" value="http://localhost/EcommenceProiect/index.php"/>
